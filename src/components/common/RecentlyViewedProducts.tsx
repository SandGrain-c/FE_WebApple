...
function RecentlyViewedCard({ product }: { product: RecentlyViewedProduct }) {
  return (
    <Link
      ...
      className="group flex h-full min-h-[96px] items-center gap-3 rounded-2xl border border-surface-container-high bg-white p-3 transition hover:-translate-y-0.5 hover:shadow-md"
    >
